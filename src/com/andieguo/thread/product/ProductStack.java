...
/**
 * ///// // ProducerConsumer.java // // @author 叶雨 // // 这是个很重要的Thread例子。需要注意的是：
 * // wait() 必须在synchronized 函数或者代码块里面 // wait()会让已经获得synchronized
 ...
 * 所以wait()的使用，必须存在2个以上线程，而且必须在不同的条件下唤醒wait()中的线程。 // // // 以下的例子： //
