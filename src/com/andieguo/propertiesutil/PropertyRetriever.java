...
public class PropertyRetriever {
	 ...
	 *            The property name.
	 * @param def
	 *            The default value if the property value is undefined or empty.
	 *
	 ...
	 *            The property name.
	 * @param enums
	 *            A string array defining the acceptable values.
	 *
	 * @return The property as a string.
	 *
	 * @throws PropertyParseException
	 ...
	 *            The property name.
	 * @param enumClass
	 *            The enumeration class specifying the acceptable values.
	 *
	...
	/**
	 * Retrieves an optional enumerated constant. String case is ignored during
	 * comparison.
	 *
	 * @param key
	 *            The property name.
	 ...
	 *             On a missing or invalid property.
	 */
	public URL getURL(final String key) throws PropertyParseException {
	 ...
	 *             On an invalid property.
	 */
	public URL getOptURL(final String key, final URL def) throws PropertyParseException {
