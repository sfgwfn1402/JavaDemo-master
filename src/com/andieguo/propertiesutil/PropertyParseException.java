...
public class PropertyParseException extends Exception {
	 ...
	 *            The exception message.
	 * @param propertyKey
	 *            The key of the property that caused the exception,
	...
	/**
	 * Returns the key of the property that caused the exception, {@code null}
	...
	/**
	 * Returns the value of the property that caused the exception, {@code null}
	 * if unknown or not applicable.
	 *
