...
public class PropertyRetrieverTest extends TestCase {
	...
	public void testGetOptBoolean() throws Exception {
	...
	public void testGetOptBooleanEmpty() throws Exception {
	...
	public void testgetOptInt() throws Exception {
	...
	public void testgetOptIntEmpty() throws Exception {
	...
	public void testGetOptLong() throws Exception {
	...
	public void testGetOptLongEmpty() throws Exception {
	...
	public void testGetOptFloat() throws Exception {
	...
	public void testGetOptString() throws Exception {
	...
	public void testGetOptStringEmpty() throws Exception {
	...
	public void testGetEnumString() throws Exception {
	...
	public void testGetOptEnumString() throws Exception {
	...
	public void testGetOptEnumStringEmpty() throws Exception {
	...
	public void testGetEnum() throws Exception {
		...
		assertEquals(java.util.concurrent.TimeUnit.SECONDS,
				pr.getEnum("app.timeUnit", java.util.concurrent.TimeUnit.class));
	}

	public void testGetOptEnum() throws Exception {

		PropertyRetriever pr = new PropertyRetriever(new Properties());

		assertEquals(java.util.concurrent.TimeUnit.SECONDS, pr.getOptEnum("app.timeUnit",
				java.util.concurrent.TimeUnit.class, java.util.concurrent.TimeUnit.SECONDS));
	}

	public void testGetOptEnumEmpty() throws Exception {
	...
	public void testGetOptURL() throws Exception {
	...
	public void testGetOptURLEmpty() throws Exception {
