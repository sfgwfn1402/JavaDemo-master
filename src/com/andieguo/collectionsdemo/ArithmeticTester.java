			...
			if ((exp[i].equals(new String("("))) || (exp[i].equals(new String("[")))
				...
				if ((exp[i].equals(new String(")"))) && mystack.empty() && mystack.peek().equals(new String("("))) {
					...
					if ((exp[i].equals(new String(")"))) && mystack.empty() && !mystack.peek().equals(new String("("))) {
						...
						if ((exp[i].equals(new String("]"))) && mystack.empty()
								&& mystack.peek().equals(new String("["))) {
							mystack.pop();
						} else {
							if ((exp[i].equals(new String("]"))) && mystack.empty()
									&& !mystack.peek().equals(new String("["))) {
								...
								if ((exp[i].equals(new String("}"))) && mystack.empty()
									...
									if ((exp[i].equals(new String("}"))) && mystack.empty()
										...
										if (((exp[i].equals(new String(")"))) || (exp[i].equals(new String("]"))) || (exp[i]
												.equals(new String("}")))) && !mystack.empty()) {
