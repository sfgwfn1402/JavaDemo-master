...
public class PropertiesTester extends TestCase {
	...
	public void readFile() {
		...
		System.err.println(PropertiesTester.class.getResource("/config.properties"));
		/**
		 * output file:/E:/workspace_zonesion_5/JavaDemo/bin/com/andieguo/
		 * propertiesdemo/ file:/E:/workspace_zonesion_5/JavaDemo/bin/ 分析：
		 * 1、如果加载文件时:文件名以""开头，则从类路径加载； 2、如果加载文件时:文件名以"/"开头，则从
		 **/
	}
